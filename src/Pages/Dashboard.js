      ...
      <div className="page-wrapper pt-5">
        ...
        <div className="container-fluid">
                ...
                <div className="row px-3" style={{background: "linear-gradient(146.85deg, #5059F4 -13.31%, #E1ECFE -13.31%, #5451FF 36.91%, #3A48F5 85.7%)"}}>
                  <div className="col-md-12 col-12">
                    <div className="row  align-items-center justify-content-between py-4 mt-5 dummy-data" style={{background: "rgba(255, 255, 255, 0.2)"}}>
                      ...
                      <div className="col-6">
                        <p className="text-center mobile-stats-key">{userStats?.roi_income || userStats?.referral_income
                            ? roundTo(
                                Number(
                            ...
                            : 0}{" "}
                          USDT</p>
                        <p className="text-center mobile-stats-key">{totalInvest ? roundTo(totalInvest, 4) : 0} USDT</p>
                        <p className="text-center mobile-stats-key">{userStats?.roi_income
                            ? roundTo(userStats?.roi_income, 4)
                            : 0}{" "}
                          USDT</p>
                        <p className="text-center mobile-stats-key">{userStats?.directs ? userStats?.directs : 0}</p>
                        <p className="text-center mobile-stats-key">{userStats?.referral_income
            ...
            <div className="row mt-4 mb-3">
                ...
                <div className="d-block-ai-assitent justify-content-between align-items-center ai-banner">
                  <div className="d-flex align-items-center ai-wrap">
                    ...
                    <div className="">
                      ...
                      <h6 className="">
                        Maximize your investment potential with our AI
                        assistent.{" "}
                        <a href="#">
                          <u>Check Out</u>
                        </a>
              ...
              {window.innerWidth < 768 ? (
                !mainBtn ? (
                  <div className="col-md-4 mt-3 d-flex flex-column-reverse">
